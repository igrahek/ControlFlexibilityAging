...
model = hssm.HSSM(
    ...
    include=[
        {
            "name": "v",
            "formula": "v ~ 1 + intervalType * blockType * Age + congruency + (1 + congruency + intervalType * blockType | subj_idx)",
            "prior": {
        ...
        {
            "name": "a",
            "formula": "a ~ 1 + intervalType * blockType * Age + scaledRunningTime + (1 + scaledRunningTime + intervalType * blockType | subj_idx)",
            "prior": {
...
# Save the model
samples.to_netcdf('../output/Model1')

...
# Import data
data = pd.read_csv('../data/DDM_Mixed_AllSubs.csv')

data['intervalType'] = data['intervalType'].replace({'Accuracy': 0.5, 'Speed': -0.5})
data['blockType'] = data['blockType'].replace({'Fixed': 0.5, 'Mixed': -0.5})
...
model = hssm.HSSM(
    ...
    include=[
        {
            "name": "v",
            "formula": "v ~ 1 + intervalType * blockType * Age + intervalType * blockType * Age_2 + congruency + (1 + congruency + intervalType * blockType | subj_idx)",
            "prior": {
                "Intercept": {"name": "Normal", "mu": 1, "sigma": 2, "initval": 1},
                "intervalType": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "blockType": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "congruency": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "Age": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "Age_2": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "intervalType:blockType": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "intervalType:Age": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "intervalType:Age_2": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "blockType:Age": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "blockType:Age_2": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "intervalType:blockType:Age": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                "intervalType:blockType:Age_2": {"name": "Normal", "mu": 0, "sigma": 1, "initval": 0},
                ...
                "blockType|subj_idx": {"name": "Normal", "mu": 0, "sigma": {"name": "Weibull", "alpha": 1.5, "beta": 0.3}},
                "congruency|subj_idx": {"name": "Normal", "mu": 0, "sigma": {"name": "Weibull", "alpha": 1.5, "beta": 0.3}},
                "intervalType:blockType|subj_idx": {"name": "Normal", "mu": 0, "sigma": {"name": "Weibull", "alpha": 1.5, "beta": 0.3}}
            },
            "link": "identity",
        },
        {
        ...
        {
            "name": "a",
            "formula": "a ~ 1 + intervalType * blockType * Age + intervalType * blockType * Age_2 + scaledRunningTime + (1 + scaledRunningTime + intervalType * blockType | subj_idx)",
            "prior": {

...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.Acc = brm(hit ~ intervalType*blockType*Age + Congruency + Congruency:Age + intervalType*blockType*Age_2 + Congruency:Age_2  + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * blockType|uniqueid),
                                         data=df.trial,
                                         family="bernoulli",
                                         #prior = prior,
                                         iter  = 20000,
...
saveRDS(model.Acc,file="../output/model_linear_quadratic_age.Acc_Congruency.rds")

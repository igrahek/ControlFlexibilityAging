...
### Fit the RT model
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.RT.SwitchRepeat = brm(AccRT ~ Congruency + intervalType * Switch * Age + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * Switch|uniqueid),
...
saveRDS(model.RT.SwitchRepeat,file="../output/model_linear_age.RTSwitchRepeat.rds")

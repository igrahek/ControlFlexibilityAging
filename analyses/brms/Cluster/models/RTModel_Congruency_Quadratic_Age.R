...
### Fit the RT model
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.RT = brm(AccRT ~ intervalType*blockType*Age_2 + Congruency + Congruency:Age_2 + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * blockType|uniqueid),
                                        data=df.trial,
                                        family=exgaussian(),
                                        #prior = prior,
                                        cores = 4,
...
saveRDS(model.RT,file="../output/model_quadratic_age.RT_Congruency.rds")

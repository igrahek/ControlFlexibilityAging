...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.Acc.SwitchRepeat = brm(hit ~ Congruency + intervalType*Switch*Age_2 + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * Switch|uniqueid),
...
saveRDS(model.Acc.SwitchRepeat,file="../output/model_quadratic_age.AccSwitchRepeat.rds")

...
### Fit the RT model
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.RT = brm(AccRT ~ Congruency + intervalType * blockType * Age + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * blockType|uniqueid),
                                        data=df.trial,
                                        family=exgaussian(),
                                        #prior = prior,
                                        cores = 4,
...
saveRDS(model.RT,file="../output/model_linear_age.RT.rds")

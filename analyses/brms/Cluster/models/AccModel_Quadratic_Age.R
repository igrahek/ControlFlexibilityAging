...
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.Acc = brm(hit ~ Congruency + intervalType*blockType*Age_2 + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * blockType|uniqueid),
                                         data=df.trial,
                                         family="bernoulli",
                                         #prior = prior,
                                         iter  = 20000,
...
saveRDS(model.Acc,file="../output/model_quadratic_age.Acc.rds")

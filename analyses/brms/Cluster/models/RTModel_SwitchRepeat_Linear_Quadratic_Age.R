...
### Fit the RT model
#%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
model.RT.SwitchRepeat = brm(AccRT ~ Congruency + intervalType * Switch * Age + intervalType * Switch * Age_2 + scaledIntervalSessionNum + scaledIntervalLength + scaledRunningTime + (Congruency + intervalType * Switch|uniqueid),
...
saveRDS(model.RT.SwitchRepeat,file="../output/model_linear_quadratic_age.RTSwitchRepeat.rds")
